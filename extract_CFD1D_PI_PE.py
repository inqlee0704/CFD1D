...
def main():
    ...
    # std
    df_std[f"Palv_LUL_PI_std"] = Palv_LUL_PI.std()
    df_std[f"Palv_LLL_PI_std"] = Palv_LLL_PI.std()
    df_std[f"Palv_RUL_PI_std"] = Palv_RUL_PI.std()
    df_std[f"Palv_RML_PI_std"] = Palv_RML_PI.std()
    df_std[f"Palv_RLL_PI_std"] = Palv_RLL_PI.std()
    df_std[f"Palv_All_PI_std"] = Palv_All_PI.std()
    # n
    ...
    # std
    df_std[f"Ptp_LUL_PI_std"] = Ptp_LUL_PI.std()
    df_std[f"Ptp_LLL_PI_std"] = Ptp_LLL_PI.std()
    df_std[f"Ptp_RUL_PI_std"] = Ptp_RUL_PI.std()
    df_std[f"Ptp_RML_PI_std"] = Ptp_RML_PI.std()
    df_std[f"Ptp_RLL_PI_std"] = Ptp_RLL_PI.std()
    df_std[f"Ptp_All_PI_std"] = Ptp_All_PI.std()
    # n
    ...
    # std
    df_std[f"FF_LUL_PI_std"] = FF_LUL_PI.std()
    df_std[f"FF_LLL_PI_std"] = FF_LLL_PI.std()
    df_std[f"FF_RUL_PI_std"] = FF_RUL_PI.std()
    df_std[f"FF_RML_PI_std"] = FF_RML_PI.std()
    df_std[f"FF_RLL_PI_std"] = FF_RLL_PI.std()
    df_std[f"FF_All_PI_std"] = FF_All_PI.std()
    # n
    ...
    # std
    df_std[f"FR_LUL_PI_std"] = FR_LUL_PI.std()
    df_std[f"FR_LLL_PI_std"] = FR_LLL_PI.std()
    df_std[f"FR_RUL_PI_std"] = FR_RUL_PI.std()
    df_std[f"FR_RML_PI_std"] = FR_RML_PI.std()
    df_std[f"FR_RLL_PI_std"] = FR_RLL_PI.std()
    df_std[f"FR_All_PI_std"] = FR_All_PI.std()
    # sum
    ...
    # std
    df_std[f"R_LUL_PI_std"] = AR_LUL_PI.std()
    df_std[f"R_LLL_PI_std"] = AR_LLL_PI.std()
    df_std[f"R_RUL_PI_std"] = AR_RUL_PI.std()
    df_std[f"R_RML_PI_std"] = AR_RML_PI.std()
    df_std[f"R_RLL_PI_std"] = AR_RLL_PI.std()
    df_std[f"R_All_PI_std"] = AR_All_PI.std()
    # mean
    ...
    # std
    df_std[f"PalvFR_LUL_PI_std"] = PQ_LUL_PI.std()
    df_std[f"PalvFR_LLL_PI_std"] = PQ_LLL_PI.std()
    df_std[f"PalvFR_RUL_PI_std"] = PQ_RUL_PI.std()
    df_std[f"PalvFR_RML_PI_std"] = PQ_RML_PI.std()
    df_std[f"PalvFR_RLL_PI_std"] = PQ_RLL_PI.std()
    df_std[f"PalvFR_All_PI_std"] = PQ_All_PI.std()
    # n
    ...
    # std
    df_std[f"Palv_LUL_PE_std"] = Palv_LUL_PE.std()
    df_std[f"Palv_LLL_PE_std"] = Palv_LLL_PE.std()
    df_std[f"Palv_RUL_PE_std"] = Palv_RUL_PE.std()
    df_std[f"Palv_RML_PE_std"] = Palv_RML_PE.std()
    df_std[f"Palv_RLL_PE_std"] = Palv_RLL_PE.std()
    df_std[f"Palv_All_PE_std"] = Palv_All_PE.std()
    # n
    ...
    # std
    df_std[f"Ptp_LUL_PE_std"] = Ptp_LUL_PE.std()
    df_std[f"Ptp_LLL_PE_std"] = Ptp_LLL_PE.std()
    df_std[f"Ptp_RUL_PE_std"] = Ptp_RUL_PE.std()
    df_std[f"Ptp_RML_PE_std"] = Ptp_RML_PE.std()
    df_std[f"Ptp_RLL_PE_std"] = Ptp_RLL_PE.std()
    df_std[f"Ptp_All_PE_std"] = Ptp_All_PE.std()
    # n
    ...
    # std
    df_std[f"FF_LUL_PE_std"] = FF_LUL_PE.std()
    df_std[f"FF_LLL_PE_std"] = FF_LLL_PE.std()
    df_std[f"FF_RUL_PE_std"] = FF_RUL_PE.std()
    df_std[f"FF_RML_PE_std"] = FF_RML_PE.std()
    df_std[f"FF_RLL_PE_std"] = FF_RLL_PE.std()
    df_std[f"FF_All_PE_std"] = FF_All_PE.std()
    # n
    ...
    # std
    df_std[f"FR_LUL_PE_std"] = FR_LUL_PE.std()
    df_std[f"FR_LLL_PE_std"] = FR_LLL_PE.std()
    df_std[f"FR_RUL_PE_std"] = FR_RUL_PE.std()
    df_std[f"FR_RML_PE_std"] = FR_RML_PE.std()
    df_std[f"FR_RLL_PE_std"] = FR_RLL_PE.std()
    df_std[f"FR_All_PE_std"] = FR_All_PE.std()
    # sum
    ...
    # std
    df_std[f"R_LUL_PE_std"] = AR_LUL_PE.std()
    df_std[f"R_LLL_PE_std"] = AR_LLL_PE.std()
    df_std[f"R_RUL_PE_std"] = AR_RUL_PE.std()
    df_std[f"R_RML_PE_std"] = AR_RML_PE.std()
    df_std[f"R_RLL_PE_std"] = AR_RLL_PE.std()
    df_std[f"R_All_PE_std"] = AR_All_PE.std()
    # mean
    ...
    # std
    df_std[f"PalvFR_LUL_PE_std"] = PQ_LUL_PE.std()
    df_std[f"PalvFR_LLL_PE_std"] = PQ_LLL_PE.std()
    df_std[f"PalvFR_RUL_PE_std"] = PQ_RUL_PE.std()
    df_std[f"PalvFR_RML_PE_std"] = PQ_RML_PE.std()
    df_std[f"PalvFR_RLL_PE_std"] = PQ_RLL_PE.std()
    df_std[f"PalvFR_All_PE_std"] = PQ_All_PE.std()
    # n
